    ...
    <div className={styles.page}>
      ...
      <main className={styles.main}>
        <article className={styles.article}>
          ...
          {/* ACCOUNT */}
          <section className={styles.section}>
            <h2 className={styles.sectionTitle}>Račun / Account</h2>
            <p>
          ...
          <section className={styles.section}>
            ...
            <p>
              NaBajk je brezplačna platforma, ki se zagotavlja &bdquo;takšna kot je&ldquo;, brez kakršnih koli garancij za neprekinjeno delovanje, točnost podatkov, zanesljivost GPS snemanja ali primernost za določen namen. Storitev lahko kadar koli spremenimo ali ukinemo brez predhodnega obvestila.
            </p>
            <p>
              NaBajk is a free platform provided &ldquo;as is&rdquo;, without any warranties of continuous availability, data accuracy, GPS recording reliability, or fitness for a particular purpose. The service may be changed or discontinued at any time without prior notice.
            </p>
          </section>
          ...
          {/* LOCATION DATA */}
          <section className={styles.section}>
            <h2 className={styles.sectionTitle}>Lokacijski podatki / Location data</h2>
            <p>
          ...
          {/* PROHIBITED CONDUCT */}
          <section className={styles.section}>
            <h2 className={styles.sectionTitle}>Prepovedana ravnanja / Prohibited conduct</h2>
            <p>Prepovedano je / It is prohibited to:</p>
            <ul>
              <li>Nalagati lažne, zavajajoče ali nevarne poti. / Upload false, misleading, or dangerous routes.</li>
              <li>Nadlegovati ali žaliti druge uporabnike v klepetalnicah skupinskih voženj. / Harass or abuse other users in group ride chats.</li>
              <li>Samodejno zbirati (scraping) podatke iz aplikacije. / Automatically scrape data from the app.</li>
              <li>Ustvariti nov račun z namenom izogibanja prepovedi. / Create a new account to circumvent a ban or suspension.</li>
              <li>Kakorkoli posegati v delovanje aplikacije ali njene infrastrukture. / Interfere with the operation of the app or its infrastructure.</li>
            </ul>
          </section>
          ...
          {/* SERVICE TERMINATION */}
          <section className={styles.section}>
            <h2 className={styles.sectionTitle}>Preklic storitve / Service termination</h2>
            <p>
          ...
          <section className={styles.section}>
            ...
            <p>
              Za vprašanja v zvezi s pogoji uporabe nas kontaktirajte na: <a href="mailto:nabajk.si@gmail.com">nabajk.si@gmail.com</a>
            </p>
            <p>
              For questions about these terms contact us at: <a href="mailto:nabajk.si@gmail.com">nabajk.si@gmail.com</a>
            </p>
          </section>
